...
const PublishedCourses = () => {
  ...
  // savingId: courseGroupId đang được lưu giá, null = không có
  ...
  /**
   * Gọi API cập nhật giá khuyến mãi.
   * discountPrice = null  → xóa khuyến mãi
   * discountPrice = <số>  → giá thực học viên trả (đã validate < price ở CoursePricingEditor)
   */
  ...
  // Tính giá hiệu lực để hiển thị trên header thẻ
